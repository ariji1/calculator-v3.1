...
import javafx.scene.text.TextFlow;import java.awt.Event;
...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		setupLabelUI(error_term1, "Arial", 18, Calculator.WINDOW_WIDTH-120, Pos.BASELINE_RIGHT, 400, 360); // Label initialization for errorterm1
		setupLabelUI(error_term2, "Arial", 18, Calculator.WINDOW_WIDTH-120, Pos.BASELINE_RIGHT, 10, 205);
		...
		errMeasuredValue3.setLayoutX(24);  
		...
		errMeasuredValue4.setLayoutX(24);  
		...
		theRoot.getChildren().addAll(label_DoubleCalculator, label_Operand1,label_Operand1ErrorTerm, text_Operand1,text_Operand1ErrorTerm, label_errOperand1,  
				label_Operand2,label_Operand2ErrorTerm, text_Operand2, text_Operand2ErrorTerm, label_errOperand2, label_Result,label_ResultErrorTerm, text_Result, text_ResultErrorTerm, label_errResult, 
...
//		}
	...
	private void addOperands_err(){
        // It is to clear the text for error message at operand2
			...
			label_ResultErrorTerm.setText("Sum");								// change the title of the field to "Sum"
			}
			else {														// Some error occurred while doing the addition.
	...
	private void subOperands_err(){
        // It is to clear the text for error message at operand2
			...
			if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
			text_ResultErrorTerm.setText(theAnswer);							// If okay, display it in the result field and
			label_ResultErrorTerm.setText("Subtraction");								// change the title of the field to "Sum"
			}
			else {														// Some error occurred while doing the addition.
			text_ResultErrorTerm.setText("");									// Do not display a result if there is an error.				
			label_ResultErrorTerm.setText("Result");							// Reset the result label if there is an error.
	...
	private void mpyOperands_err(){
        // It is to clear the text for error message at operand2
			...
			if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
			text_ResultErrorTerm.setText(theAnswer);							// If okay, display it in the result field and
			label_ResultErrorTerm.setText("Product");								// change the title of the field to "Sum"
			}
			else {														// Some error occurred while doing the addition.
			text_ResultErrorTerm.setText("");									// Do not display a result if there is an error.				
			label_ResultErrorTerm.setText("Result");							// Reset the result label if there is an error.
...
//		}
		if (theAnswer.length() > 0) {								// Check the returned String to see if it is okay
			text_ResultErrorTerm.setText(theAnswer);							// If okay, display it in the result field and
			label_ResultErrorTerm.setText("quotient");								// change the title of the field to "Quotient"
		}
		else {														// Some error occurred while doing the division.
			text_ResultErrorTerm.setText("");									// Do not display a result if there is an error.				
			label_ResultErrorTerm.setText("Result");							// Reset the result label if there is an error.
